...
(function (angular) {
  ...
  function Users($resource, Photo, SERVER_URL) {
    ...
    var postUrl = SERVER_URL + '/user' + '/:login' + '/:findOne' + '/:update' + '/:changePassword';
...
(function () {
  ...
  PlaceCreateController.$inject = ['$scope', '$q', '$timeout', '$window', '$ionicPopover', '$ionicModal', '$state', '$location', 'PlaceCreateModel', 'Places', 'U', 'Message', 'Upload', 'Province', 'UniqueKeywords', 'MultipleKeywords', 'SERVER_URL'];

  function PlaceCreateController($scope, $q, $timeout, $window, $ionicPopover, $ionicModal, $state, $location, PlaceCreateModel, Places, U, Message, Upload, Province, UniqueKeywords, MultipleKeywords, SERVER_URL) {
    var _ = $window._;
    var initPromise;
    var noLoadingStates = [];
    var vm = this;
  ...
  function PlaceListModel() {
    var Model = {
      ...
      columnFilterOption: {
        ...
        { name: 'category', show: true }, { name: 'province', show: true }, { name: 'address', show: true }, { name: 'summary', show: true }, { name: 'theme', show: true }, { name: 'averageRating', show: true }, { name: 'phone', show: true }, { name: 'createdAt', show: true }]
      }
    };
...
(function () {
  ...
  PlaceUpdateController.$inject = ['$scope', '$q', '$timeout', '$window', '$ionicPopover', '$ionicModal', '$state', '$location', 'PlaceUpdateModel', 'Places', 'U', 'Message', 'Upload', 'Province', 'UniqueKeywords', 'MultipleKeywords', 'SERVER_URL'];

  function PlaceUpdateController($scope, $q, $timeout, $window, $ionicPopover, $ionicModal, $state, $location, PlaceUpdateModel, Places, U, Message, Upload, Province, UniqueKeywords, MultipleKeywords, SERVER_URL) {
    var _ = $window._;
    var initPromise;
    var noLoadingStates = [];
    var vm = this;
...
(function () {
  ...
  function PostListController($scope, $q, $ionicPopover, $window, PostListModel, U, Posts, Message) {
    ...
    function postDestroyPost(extraQuery) {
      ...
      angular.extend(queryWrapper.query.where, extraQuery);
      return Posts.destroyPost(queryWrapper).$promise.then(function (postsWrapper) {
        return postsWrapper;
      });
    }
  }
